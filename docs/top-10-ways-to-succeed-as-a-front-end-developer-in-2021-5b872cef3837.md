...
知道如何使用 REST APIs，闭着眼睛执行 DOM 操作(不确定这是否可能)，了解客户端、服务器和数据库之间的关系。了解互联网在高层次上是如何工作的也是有帮助的。我可以继续说下去，但我想我已经讲了基本的内容。继续前进。
...
尽管有一些 react 特有的东西在运行，但我们可以清楚地注意到这里使用的核心 Javascript 特性。继续下一个。
